...
export default function LaporanPiutangUktIndex({
    ...
    const getStatusBadge = (status: string) => {
        switch (status) {
            ...
            case 'parsial':
                return <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-amber-100 dark:bg-amber-950 text-amber-800 dark:text-amber-300">PARSIAL</span>;
            default:
                    ...
                    <div className="w-48">
                        <Select
                            ...
                            onValueChange={(val) => {
                                ...
                                handleFilterChange(val, selectedProdi);
                            }}
                        >
                    ...
                    <div className="w-56">
                        <Select
                            ...
                            onValueChange={(val) => {
                                ...
                                handleFilterChange(selectedTahun, val);
                            }}
                        >
                            <SelectTrigger className="h-9 text-xs">
                        ...
                        <ResponsiveTable>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHead align="right" className="w-36">Total Tagihan</TableHead>
                                    <TableHead align="right" className="w-36 font-bold text-red-600">Sisa Piutang</TableHead>
                                    <TableHead align="center" className="w-32">Jatuh Tempo</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {tagihans.length === 0 ? (
                                    ...
                                    tagihans.map((t, idx) => (
                                        <TableRow key={t.id}>
                                            ...
                                            <TableCell align="center" className="text-xs text-muted-foreground">
